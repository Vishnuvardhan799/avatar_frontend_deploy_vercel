...
const Index = () => {
  ...
  const [conciergeMode, setConciergeMode] = useState(null);
  // State to track if user has made a selection in current session
  const [hasSelectedMode, setHasSelectedMode] = useState(false);

  // Load saved preference from localStorage on component mount
  useEffect(() => {
    const savedMode = localStorage.getItem("conciergeMode");
    if (savedMode === "avatar" || savedMode === "voice-only") {
      setConciergeMode(savedMode);
  ...
  useEffect(() => {
    if (conciergeMode) {
      localStorage.setItem("conciergeMode", conciergeMode);
    }
  }, [conciergeMode]);
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={index}
                className="overflow-hidden shadow-luxury hover:shadow-hover transition-all duration-300 animate-scale-in group"
              >
      ...
      <section id="amenities" className="py-20 px-6 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Indulge in our premium facilities designed for your comfort and
              convenience
            </p>
          </div>
              ...
              {[
                {
                  icon: Waves,
                  title: "Spa & Wellness",
                  desc: "Rejuvenate in our award-winning spa with premium treatments",
                  link: "/spa-wellness",
                },
                {
                  icon: Dumbbell,
                ...
                },
                {
                  ...
                  desc: "Complimentary internet throughout the property",
                  link: null,
                },
                {
                  icon: Car,
                  title: "Valet Parking",
                  desc: "Secure parking with professional valet service",
                  link: "/valet-parking",
                },
              ].map((amenity, index) => (
                <div
                  ...
                  className={`flex items-start space-x-4 ${
                    amenity.link
                      ? "cursor-pointer hover:bg-muted/50 p-4 rounded-lg transition-colors"
                      : "p-4"
                  }`}
            ...
            <Card className="overflow-hidden shadow-luxury animate-scale-in">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Award-winning fine dining with innovative cuisine and
                  impeccable service
                </p>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={index}
                className="overflow-hidden shadow-luxury hover:shadow-hover transition-all duration-300 animate-scale-in"
              >
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button
          ...
          onClick={() => {
            setConciergeMode("voice-only");
            setShowSupport(true);
            // Always reset selection state when opening to allow user to choose mode
            setHasSelectedMode(false);
            // Save preference to localStorage
            if (typeof window !== 'undefined') {
              localStorage.setItem('conciergeMode', 'voice-only');
            }
          }}
        >
          <svg 
          ...
          <span className="font-medium">Talk to Voice Assistant</span>
        </Button>
      </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    We're working hard to bring you the full avatar experience. Please check back soon!
                  </p>
                  <Button
                    onClick={() => {
                      setConciergeMode("voice-only");
